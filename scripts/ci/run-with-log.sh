...
interval_s="${ARGOSFS_CI_LOG_INTERVAL_S:-120}"
tail_lines="${ARGOSFS_CI_LOG_TAIL_LINES:-30}"
success_tail_lines="${ARGOSFS_CI_LOG_SUCCESS_TAIL_LINES:-80}"
failure_tail_lines="${ARGOSFS_CI_LOG_FAILURE_TAIL_LINES:-240}"

case "$interval_s:$tail_lines:$success_tail_lines:$failure_tail_lines" in
    *[!0-9:]*|:*|*::*)
        echo "invalid ARGOSFS_CI_LOG_* numeric setting" >&2
        exit 2
        ;;
esac
